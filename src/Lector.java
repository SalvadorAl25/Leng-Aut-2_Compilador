...
public class Lector 
{
	...
	public void Lectura(File archivo, String texto, Interfaz Int)
	{
		...
		try
		{
			...
			do
			{
				cad=buffer.readLine(); //Lee la línea y hace un salto de línea
				//Int.imprimirConsola("Renglón "+renglon+": "+cad);
				//Int.imprimirConsola("Renglón \t  Columna \t  Token  \t  Tipo de Dato");
				if(cad!=null) 
				{
					cad=cad.trim();
					...
					for (int i = 0; i < cad.length(); i++) 
					{
						...
						if(mensaje)
						{ //Todo lo que escriba será mensaje, hasta que escriba un paréntesis
							if(caracter.equals("'"))
							{
						...
						else
						{
							if(!caracter.equals("=") )
							{
								...
								if(elementoanterior.equals("="))
								{
									//Int.imprimirConsola(renglon+"\t"+i+"\t"+elementoanterior+"\t Igual (asignación) ");
									archivooriginal.add(elementoanterior);
									archivodatos.add("=");
								}
								elementoanterior="";
							 ...
							 || expresion.isSeparador(caracter) || expresion.isPunto(caracter))
							{
								...
								else
								{
									...
									if(expresion.isPalabraReservada(lexema))
									{
										...
										if(lexema.equals("if"))
										{
											//Int.imprimirConsola(renglon+"\t"+columna+"\t"+lexema+"\t Condición IF");
											archivooriginal.add(lexema);
											archivodatos.add("if");
										}
										if(lexema.equals("else"))
										{
											//Int.imprimirConsola(renglon+"\t"+columna+"\t"+lexema+"\t Condición ELSE");
											archivooriginal.add(lexema);
										...
										{
											//Int.imprimirConsola(renglon+"\t"+columna+"\t"+lexema+"\t Método Imprimir");
											archivooriginal.add(lexema);
									...
									else
									{
										...
										else
										{
											...
											{
												//Int.imprimirConsola(renglon+"\t"+columna+"\t"+lexema+"\t Identificador no válido");
												archivooriginal.add(lexema);
												archivodatos.add("IDNoVálido");
											}
										}
									}
									if(expresion.isEntero(lexema))
									{
										//Int.imprimirConsola(renglon+"\t"+columna+"\t"+lexema+"\t Número entero");
										archivooriginal.add(lexema);
									...
									{
										//Int.imprimirConsola(renglon+"\t"+columna+"\t"+lexema+"\t Número decimal");
										archivooriginal.add(lexema);
										archivodatos.add("num");
									}
									...
									{
										//Int.imprimirConsola(renglon+"\t"+columna+"\t"+lexema+"\t Número Flotante");
										archivooriginal.add(lexema);
										archivodatos.add("num");
									}
									...
									while(simbolo || i<cad.length()-1)
									{
										...
										if(expresion.isSeparador(caracter))
										{
											...
											if(caracter.equals("("))
											{
												//Int.imprimirConsola(renglon+"\t"+i+"\t"+caracter+"\t Paréntesis que abre");
												archivooriginal.add(caracter);
												archivodatos.add("(");
											}
											if(caracter.equals(")"))
											{
												//Int.imprimirConsola(renglon+"\t"+i+"\t"+caracter+"\t Paréntesis que cierra");
												archivooriginal.add(caracter);
												archivodatos.add(")");
											}
											break;
										...
										if(expresion.isCaracterPuntuacion(caracter))
										{
											if(caracter.equals("="))
											{
												if(elementoanterior.length()!=0) 
												{
													...
													if(elementoanterior.equals("="))
													{
														//Int.imprimirConsola(renglon+"\t"+i+"\t"+"=="+"\t Igual (Comparación) ");
														archivooriginal.add("==");
														archivodatos.add("==");
														condiciones++;
													}
											...
											else
											{
												...
												{
													//Int.imprimirConsola(renglon+"\t"+i+"\t"+caracter+"\t Caracter de puntuación");
													archivooriginal.add(caracter);
										...
										{
											//Int.imprimirConsola(renglon+"\t"+i+"\t"+caracter+"\t Operador Lógico");
											archivooriginal.add(lexema);
										...
										if(expresion.isOperadorMatematico(caracter))
										{
											...
											if(caracter.equals("*"))
											{
												//Int.imprimirConsola(renglon+"\t"+i+"\t"+caracter+"\t Multiplicación");
												archivooriginal.add(caracter);
												archivodatos.add("*");
											}
											if(caracter.equals("/"))
											{
												//Int.imprimirConsola(renglon+"\t"+i+"\t"+caracter+"\t División");
												archivooriginal.add(caracter);
												archivodatos.add("/");
											}
											break;
		...
		String rutta="C:\\Users\\lnefa\\Desktop\\holi.txt";
		 try {
		...
		//Int.imprimirConsola("Analizador Léxico");
